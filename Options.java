...
switch (option) {
case 1:
FileOperations.fileDisplay("Virtualkeyrepostries");
break;
case 2:
...
case 1:
// File Add
System.out.println("Enter the name of the file to be added to the \"Virtualkeyrepostries\" folder");
String fileToAdd = sc.next();
FileOperations.createNewFile(fileToAdd, sc);
break;
case 2:
// File/Folder delete
System.out.println("Enter the name of the file to be deleted from \"Virtualkeyrepostries\" folder");
String fileToDelete = sc.next();
FileOperations.createFolderIfFolderNotAvailable("Virtualkeyrepostries");
List<String> filesToDelete =
FileOperations.fileLocations(fileToDelete, "Virtualkeyrepostries");
...
case 3:
// File/Folder Search
System.out.println("Enter the name of the file to search from \"Virtualkeyrepostries\" folder");
String fileName = sc.next();
FileOperations.createFolderIfFolderNotAvailable("Virtualkeyrepostries");
FileOperations.fileLocations(fileName, "Virtualkeyrepostries");
break;
case 4:
// Go to Previous menu
return;
